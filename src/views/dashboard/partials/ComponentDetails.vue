...
<template>
    ...
    >
        <el-tabs v-if="Object.keys(component.capabilities).length" type="border-card">
            <el-tab-pane v-if="component.capabilities.threshold" label="Threshold">
            ...
            <el-tab-pane v-if="component.capabilities.info" label="Connector Info">
                <el-table v-if="component.activeComponentConnectorInfo" :data="component.connectorInfo" stripe>
                    <el-table-column width="150" prop="key" label="Property" />
                    <el-table-column  prop="value" label="Value" />
                </el-table>
            </el-tab-pane>
            <el-tab-pane v-if="component.capabilities.componentInfo" label="Component Info">componentInfo</el-tab-pane>
